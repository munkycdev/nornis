...
///
/// For any source in a campaign and any campaign member, retrieving that source by Id should return
...
/// </summary>
[TestFixture]
[Category("Feature: campaign-sources, Property 5: Visibility Enforcement on Get")]
public class SourceVisibilityEnforcementOnGetTests
{
    [FsCheck.NUnit.Property(
        Arbitrary = [typeof(VisibilityGetArbitraries)],
        MaxTest = 100)]
    [Description("Feature: campaign-sources, Property 5: Visibility Enforcement on Get")]
    ...
    /// </summary>
    private static bool CanSee(VisibilityScope visibility, CampaignRole role, Guid requestingUserId, Guid creatorUserId) =>
        visibility switch
        {
            VisibilityScope.PartyVisible => true,
            VisibilityScope.Private => role == CampaignRole.GM || requestingUserId == creatorUserId,
